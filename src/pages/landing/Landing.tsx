    ...
    <>
      ...
      <div className='flex flex-col items-center justify-center mx-4'>
        <div className='flex flex-col md:flex-row items-center justify-center gap-2 mt-[10%]'>
          ...
          <Link to="/home">
            <button className="mx-auto mt-[10%] font-serif text-white font-weight: 600 bg-orange hover:bg-red rounded-full p-3 w-64 h-10 tracking-[1rem] mb-5 md:ml-10 transition-colors duration-300">
              Habit+
            </button>
          </Link>
          <style type="text/css">
