      ...
      <Footer bgColor={'#53B965'}  />
        ...
        <div className='flex flex-col items-center justify-center mb-20'>
          ...
          <article className='mt-8 px-8 md:text-lg lg:mx-72 text-justify'>
            <p className='indent-2'> Elegir el qué y dónde se compra puede ser una clave para el ahorro. Para que nuestra compra pueda ser más económica, los expertos recomiendan:<br></br></p>
            <ul className='list-disc'>
            <li className='mt-3'>Apostar por marcas blancas en aquellos productos en los que no se note la diferencia. <br></br></li>
            <li className='mt-3'>Elegir supermercados que son más económicos. La OCU publica un listado de estos. <br></br></li>
            <li className='mt-3'>Hacer una lista detallada con lo que se necesita antes de ir a comprar y seguirla sin dejarse llevar por tentaciones u ofertas. <br></br></li>
            <li className='mt-3'>Evitar ir a comprar con hambre. <br></br></li>
            <li className='mt-3'>Comparar los precios de los productos similares. <br></br></li>
