...
const CompraEconomica = (props: Props) => {
  return (
    <>
      <Header />
      <BackButton />
      ...
      <>
        ...
        <article className='grid grid-rows-1 p-10 md:text-2xl'>
          <p> Elegir el qué y dónde se compra puede ser una clave para el ahorro. Para que nuestra compra pueda ser más económica, los expertos recomiendan:<br></br>
