...
const CocinaSaludable = () => {
  return (
    <>
      ...
      <div className='mb-20'>
          <h1 className='text-green-font font-serif text-center text-2xl md:text-4xl font-semibold mt-14'>Cocina saludable</h1>
        <article className='grid grid-rows-1 md:text-lg mt-8 px-8 lg:mx-72 text-justify'>
        ...
        <article className='grid grid-rows-1 mt-8 px-8 md:text-lg lg:mx-72 text-justify'>
