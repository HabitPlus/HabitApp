  ...
  return (
    <>
      ...
      <div className='mt-32 flex flex-col text-red text-center px-8'>
        <h1 className='text-3xl my-6 font-serif text-center'>Contacta con Càritas</h1>
        ...
        <a href="tel:+34 936 255 770"><h3 className='text-lg'>O llamando al +34 936 255 770</h3></a>
        <style type="text/css">
          {`
          body {
