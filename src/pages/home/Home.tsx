      ...
      <div className="flex justify-center items-center p-6 mt-5">
        <div className="">
          <div className="grid grid-cols-2 grid-rows-2 md:grid-cols-4 md:grid-rows-1">
            <Link to='/nutricion'>
              <button className="p-2 w-full h-52 md:h-72 bg-green rounded-2xl drop-shadow-lg bg-black md:bg-purple-400 flex flex-col items-center justify-center gap-10">
            ...
            <Link to='/sueño'>
              <button className="p-2 w-full h-52 md:h-72 bg-blue rounded-2xl drop-shadow-lg bg-black md:bg-purple-400 flex flex-col items-center justify-center gap-2">
            ...
            <Link to='/salud-mental'>
              <button className="p-2 w-full h-52 md:h-72 bg-purple rounded-2xl drop-shadow-lg bg-black md:bg-purple-400 flex flex-col items-center justify-center gap-5">
            ...
            <Link to='/deporte'>
              <button className="p-2 w-full h-52 md:h-72 bg-yellow rounded-2xl drop-shadow-lg bg-black md:bg-purple-400 flex flex-col items-center justify-center gap-4">
