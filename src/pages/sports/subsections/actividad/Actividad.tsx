  ...
  return (
    <>
      ...
      <div className='grid grid-rows-1 md:text-lg px-8 lg:mx-72 text-justify'>
        ...
        <a className='underline text-center mt-4' href="http://www.estilosdevidasaludable.mscbs.gob.es/actividadFisica/" target='_blank' rel="noreferrer">Click Aquí</a>
        <p className='mt-4'> Descargate aplicaciones gratuitas: Mi Fit, Strava, Pedometer,
