  ...
  return (
    ...
    <Header />
      ...
      <div className='flex flex-col items-center justify-center text-center mt-10 px-8 md:px-0'>
        ...
        Fuente: <a href="https://farmaadicta.com/salud/enfermedades/higiene-del-sueno-infografia/" target='_blank' rel="noreferrer">farmaadicta.com/salud/higiene-del-sueno-infografia/</a></p> <br />
        <p className='text-black text-justify text-lg md:text-xl leading-8'>
