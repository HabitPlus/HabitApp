    ...
    <>
      ...
      <div className='flex flex-col items-center justify-center text-center mt-8 px-8 md:px-72 mb-20'>
        ...
        <div className='text-black text-justify text-lg md:text-xl leading-8'>
          <p>Fuente:
            <a href="https://farmaadicta.com/salud/enfermedades/higiene-del-sueno-infografia/" target='_blank' rel="noreferrer" className='underline'>farmaadicta.com/salud/higiene-del-sueno-infografia/</a>
          </p><br />
          <p>
